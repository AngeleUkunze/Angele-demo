        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-3" style="background-color: #f9f9f9; border-radius: 10px; padding: 30px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <h2 style="text-align: center; color: #333;">Client Registration</h2><br>
                     <form method="POST" action="forms/addclient.php">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="status" style="color: #333;">Status:</label>
                                     <select name="status" id="sector" class="form-control" required>
                        ...
                        <button type="submit" id="submitForm" style="background-color:orange; border-color: orange;" class="btn btn-primary btn-block">Register</button>
                    </form>
                </div>
            </div>
        </div>
