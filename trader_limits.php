        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2" style="background-color: white;padding: 15px;">
                    ...
                    <form method="POST" action="addnewloanlimit.php">
                        <div class="form-group">
                            <label for="limitAmount">Limit Amount:</label>
                            <input type="number" step="0.01" class="form-control" id="limitAmount" name="limit_amount" required>
                        </div><br>
                        <button type="submit" style="background-color:orange; border-color: orange;" class="btn btn-primary">Set Limit</button>
                    </form>
                </div>
            </div>
            <div class="row">
                            ...
                            <?php if ($result && mysqli_num_rows($result) > 0) : ?>
                                <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="addnewloanlimit.php?id=<?php echo $row['limit_id']; ?>" style="background-color:orange; border-color: orange;" class="btn btn-primary">Edit</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else : ?>
